...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(loginStore);
	...
	var Login = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var buttonIcon = React.createElement('div', { className: 'icon-arrow-right', style: iconStyle });
	        ...
	        if (true) {
	            ...
	            buttonIcon = React.createElement('div', { className: 'icon-loop2', style: loadingIconStyle });

	            gradientClass += ' animate';
	        }
	        var indicatorIcon = React.createElement('div', { className: 'icon-user', style: iconStyle });
	        ...
	        if (store.getState().error) {
	            ...
	            indicatorIcon = React.createElement('div', { className: 'icon-notification', style: errorIconStyle });

	            errorMessage = React.createElement(
	                'div',
	                { className: 'errorMessage' },
	                'Oops!',
	                React.createElement('div', { style: leftArrowStyle })
	            );
	        }
	        ...
	        return React.createElement(
	            'div',
	            { className: 'login' },
	            React.createElement('div', { className: gradientClass, style: { height: '3px' } }),
	            React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'submitButton', onClick: this.clickHandler },
	                        buttonIcon
	                    )
	                )
	            ),
